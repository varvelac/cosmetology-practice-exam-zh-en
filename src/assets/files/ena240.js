export const ena240 = `1. How do you properly file the natural nail:Answer_____(C)
...
51. Why should licensees do back and forth motion when using blow dryer:Answer_____(B)
a) Hairstyle 
b) Avoid burn client 
c) Customization 
d) Harden hair 
